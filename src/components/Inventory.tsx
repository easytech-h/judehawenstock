  ...
  useEffect(() => {
    if (products.length === 0) {
      const sampleProducts = [
        { name: "Laptop", description: "High-performance laptop", quantity: 20, price: 99999.99 },
        { name: "Smartphone", description: "Latest model smartphone", quantity: 50, price: 69999.99 },
        // ... (other sample products)
        { name: "Cable Organizer", description: "Neoprene cable management sleeve", quantity: 80, price: 999.99 }
      ];
